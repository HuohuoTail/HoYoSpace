				...
				lose: {
					...
					content() {
						...
						if (result.control && result.control != 'cancel2') {
							game.hyyzSkillAudio('mengsheyuan', 3)
			...
			subSkill: {
				...
				after: {
					...
					content() {
						...
						'step 3'
						if (result.control && result.control != 'cancel2') {
							game.hyyzSkillAudio('mengkanming', 1, 2)
			...
			subSkill: {
				...
				trick: {
					...
					precontent(links, player) {
						game.hyyzSkillAudio('menggufeng', 3, 4)
